...
#include "niryo_one_msgs/msg/detail/rpy__rosidl_typesupport_fastrtps_c.h"
...
using _RPY__ros_msg_type = niryo_one_msgs__msg__RPY;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = niryo_one_msgs__msg__RPY;
    is_plain =
      (
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const niryo_one_msgs__msg__RPY * ros_message = static_cast<const niryo_one_msgs__msg__RPY *>(untyped_ros_message);
  (void)ros_message;
  return cdr_serialize_niryo_one_msgs__msg__RPY(ros_message, cdr);
}
  ...
  void * untyped_ros_message)
{
  ...
  niryo_one_msgs__msg__RPY * ros_message = static_cast<niryo_one_msgs__msg__RPY *>(untyped_ros_message);
  (void)ros_message;
  return cdr_deserialize_niryo_one_msgs__msg__RPY(cdr, ros_message);
}

static uint32_t _RPY__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_niryo_one_msgs__msg__RPY(
...
static size_t _RPY__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_niryo_one_msgs__msg__RPY(
