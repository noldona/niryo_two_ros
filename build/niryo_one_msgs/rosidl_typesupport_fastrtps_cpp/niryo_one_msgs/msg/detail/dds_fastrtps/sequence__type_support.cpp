...
#include "niryo_one_msgs/msg/detail/sequence__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const niryo_one_msgs::msg::Sequence & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Member: blockly_xml
  cdr << ros_message.blockly_xml;

  // Member: python_code
  cdr << ros_message.python_code;
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  niryo_one_msgs::msg::Sequence & ros_message)
{
  // Member: id
  cdr >> ros_message.id;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = niryo_one_msgs::msg::Sequence;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const niryo_one_msgs::msg::Sequence *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<niryo_one_msgs::msg::Sequence *>(
    untyped_ros_message);
...
get_message_type_support_handle<niryo_one_msgs::msg::Sequence>()
{
  return &niryo_one_msgs::msg::typesupport_fastrtps_cpp::_Sequence__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_one_msgs, msg, Sequence)() {
  return &niryo_one_msgs::msg::typesupport_fastrtps_cpp::_Sequence__handle;
}
