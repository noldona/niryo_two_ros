...
#include "niryo_one_msgs/msg/detail/robot_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const niryo_one_msgs::msg::RPY &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  niryo_one_msgs::msg::RPY &);
size_t get_serialized_size(
  const niryo_one_msgs::msg::RPY &,
  size_t current_alignment);
size_t
...
cdr_serialize(
  const niryo_one_msgs::msg::RobotState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  niryo_one_msgs::msg::RobotState & ros_message)
{
  // Member: position
  ...
  size_t current_alignment)
{
  ...
  // Member: rpy
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        niryo_one_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RPY(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = niryo_one_msgs::msg::RobotState;
    is_plain =
      (
  ...
  size_t current_alignment)
{
  ...
  // Member: rpy
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        niryo_one_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_key_RPY(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
...
{
  auto typed_message =
    static_cast<const niryo_one_msgs::msg::RobotState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<niryo_one_msgs::msg::RobotState *>(
    untyped_ros_message);
...
get_message_type_support_handle<niryo_one_msgs::msg::RobotState>()
{
  return &niryo_one_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_one_msgs, msg, RobotState)() {
  return &niryo_one_msgs::msg::typesupport_fastrtps_cpp::_RobotState__handle;
}
