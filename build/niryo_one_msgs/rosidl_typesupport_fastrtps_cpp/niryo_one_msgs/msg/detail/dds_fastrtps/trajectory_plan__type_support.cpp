...
#include "niryo_one_msgs/msg/detail/trajectory_plan__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = niryo_one_msgs::msg::TrajectoryPlan;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const niryo_one_msgs::msg::TrajectoryPlan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<niryo_one_msgs::msg::TrajectoryPlan *>(
    untyped_ros_message);
...
{
  return &niryo_one_msgs::msg::typesupport_fastrtps_cpp::_TrajectoryPlan__handle;
}
