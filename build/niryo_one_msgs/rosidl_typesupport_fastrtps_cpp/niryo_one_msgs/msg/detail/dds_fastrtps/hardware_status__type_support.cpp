...
#include "niryo_one_msgs/msg/detail/hardware_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const niryo_one_msgs::msg::HardwareStatus & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.hardware_errors;
  }
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  niryo_one_msgs::msg::HardwareStatus & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  // Member: motor_types
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment += padding +
        eprosima::fastcdr::Cdr::alignment(current_alignment, padding) +
        (ros_message.motor_types[index].size() + 1);
    }
  }
  ...
  // Member: hardware_errors
  {
    ...
    current_alignment += padding +
      eprosima::fastcdr::Cdr::alignment(current_alignment, padding);
    size_t item_size = sizeof(ros_message.hardware_errors[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = niryo_one_msgs::msg::HardwareStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const niryo_one_msgs::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<niryo_one_msgs::msg::HardwareStatus *>(
    untyped_ros_message);
...
{
  return &niryo_one_msgs::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_one_msgs, msg, HardwareStatus)() {
  return &niryo_one_msgs::msg::typesupport_fastrtps_cpp::_HardwareStatus__handle;
}
