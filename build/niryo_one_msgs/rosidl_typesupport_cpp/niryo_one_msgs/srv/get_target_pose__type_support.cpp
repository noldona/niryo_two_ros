...
static const _GetTargetPose_Request_type_support_symbol_names_t _GetTargetPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_one_msgs, srv, GetTargetPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_one_msgs, srv, GetTargetPose_Request)),
  }
};
...
{
  return &::niryo_one_msgs::srv::rosidl_typesupport_cpp::GetTargetPose_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, niryo_one_msgs, srv, GetTargetPose_Request)() {
  return get_message_type_support_handle<niryo_one_msgs::srv::GetTargetPose_Request>();
}
...
static const _GetTargetPose_Response_type_support_symbol_names_t _GetTargetPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_one_msgs, srv, GetTargetPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_one_msgs, srv, GetTargetPose_Response)),
  }
};
...
{
  return &::niryo_one_msgs::srv::rosidl_typesupport_cpp::GetTargetPose_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, niryo_one_msgs, srv, GetTargetPose_Response)() {
  return get_message_type_support_handle<niryo_one_msgs::srv::GetTargetPose_Response>();
}
...
typedef struct _GetTargetPose_Event_type_support_ids_t
{
  const char * typesupport_identifier[2];
} _GetTargetPose_Event_type_support_ids_t;

static const _GetTargetPose_Event_type_support_ids_t _GetTargetPose_Event_message_typesupport_ids = {
  {
    "rosidl_typesupport_fastrtps_cpp",  // ::rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
    "rosidl_typesupport_introspection_cpp",  // ::rosidl_typesupport_introspection_cpp::typesupport_identifier,
  }
...
typedef struct _GetTargetPose_Event_type_support_symbol_names_t
{
  const char * symbol_name[2];
} _GetTargetPose_Event_type_support_symbol_names_t;

#define STRINGIFY_(s) #s
#define STRINGIFY(s) STRINGIFY_(s)

static const _GetTargetPose_Event_type_support_symbol_names_t _GetTargetPose_Event_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_one_msgs, srv, GetTargetPose_Event)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_one_msgs, srv, GetTargetPose_Event)),
  }
};

typedef struct _GetTargetPose_Event_type_support_data_t
{
  void * data[2];
} _GetTargetPose_Event_type_support_data_t;

static _GetTargetPose_Event_type_support_data_t _GetTargetPose_Event_message_typesupport_data = {
  {
    0,  // will store the shared library later
    0,  // will store the shared library later
  }
...
static const type_support_map_t _GetTargetPose_Event_message_typesupport_map = {
  2,
  "niryo_one_msgs",
  &_GetTargetPose_Event_message_typesupport_ids.typesupport_identifier[0],
  &_GetTargetPose_Event_message_typesupport_symbol_names.symbol_name[0],
  &_GetTargetPose_Event_message_typesupport_data.data[0],
};

static const rosidl_message_type_support_t GetTargetPose_Event_message_type_support_handle = {
  ::rosidl_typesupport_cpp::typesupport_identifier,
  reinterpret_cast<const type_support_map_t *>(&_GetTargetPose_Event_message_typesupport_map),
  ::rosidl_typesupport_cpp::get_message_typesupport_handle_function,
...
{
  return &::niryo_one_msgs::srv::rosidl_typesupport_cpp::GetTargetPose_Event_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, niryo_one_msgs, srv, GetTargetPose_Event)() {
  return get_message_type_support_handle<niryo_one_msgs::srv::GetTargetPose_Event>();
}
...
static const _GetTargetPose_type_support_symbol_names_t _GetTargetPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_one_msgs, srv, GetTargetPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_one_msgs, srv, GetTargetPose)),
  }
};
...
static const rosidl_service_type_support_t GetTargetPose_service_type_support_handle = {
  ...
  ::rosidl_typesupport_cpp::get_message_type_support_handle<niryo_one_msgs::srv::GetTargetPose_Request>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<niryo_one_msgs::srv::GetTargetPose_Response>(),
  ::rosidl_typesupport_cpp::get_message_type_support_handle<niryo_one_msgs::srv::GetTargetPose_Event>(),
...
{
  return &::niryo_one_msgs::srv::rosidl_typesupport_cpp::GetTargetPose_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, niryo_one_msgs, srv, GetTargetPose)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<niryo_one_msgs::srv::GetTargetPose>();
}
