...
static const _TrajectoryPlan_type_support_symbol_names_t _TrajectoryPlan_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, niryo_one_msgs, msg, TrajectoryPlan)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_one_msgs, msg, TrajectoryPlan)),
  }
};
...
{
  return &::niryo_one_msgs::msg::rosidl_typesupport_cpp::TrajectoryPlan_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, niryo_one_msgs, msg, TrajectoryPlan)() {
  return get_message_type_support_handle<niryo_one_msgs::msg::TrajectoryPlan>();
}
