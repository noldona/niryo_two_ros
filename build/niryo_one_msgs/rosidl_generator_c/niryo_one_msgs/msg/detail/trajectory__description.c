...
static char niryo_one_msgs__msg__Trajectory__FIELD_NAME__id[] = "id";
static char niryo_one_msgs__msg__Trajectory__FIELD_NAME__name[] = "name";
static char niryo_one_msgs__msg__Trajectory__FIELD_NAME__description[] = "description";
static char niryo_one_msgs__msg__Trajectory__FIELD_NAME__trajectory_plan[] = "trajectory_plan";

static rosidl_runtime_c__type_description__Field niryo_one_msgs__msg__Trajectory__FIELDS[] = {
  {
    {niryo_one_msgs__msg__Trajectory__FIELD_NAME__id, 2, 2},
    {
  ...
  {
    {niryo_one_msgs__msg__Trajectory__FIELD_NAME__name, 4, 4},
    {
  ...
  {
    {niryo_one_msgs__msg__Trajectory__FIELD_NAME__description, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_STRING,
      0,
      0,
  ...
  {
    {niryo_one_msgs__msg__Trajectory__FIELD_NAME__trajectory_plan, 15, 15},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription niryo_one_msgs__msg__Trajectory__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {niryo_one_msgs__msg__Trajectory__FIELDS, 4, 4},
    },
    {niryo_one_msgs__msg__Trajectory__REFERENCED_TYPE_DESCRIPTIONS, 28, 28},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[15].fields = niryo_one_msgs__msg__TrajectoryPlan__get_type_description(NULL)->type_description.fields;
...
niryo_one_msgs__msg__Trajectory__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *niryo_one_msgs__msg__Trajectory__get_individual_type_description_source(NULL),
    ...
    sources[16] = *niryo_one_msgs__msg__TrajectoryPlan__get_individual_type_description_source(NULL);
