...
niryo_one_msgs__msg__RobotState__init(niryo_one_msgs__msg__RobotState * msg)
{
  ...
  if (!geometry_msgs__msg__Point__init(&msg->position)) {
    niryo_one_msgs__msg__RobotState__fini(msg);
    return false;
  }
  // rpy
...
niryo_one_msgs__msg__RobotState__create(void)
{
  ...
  niryo_one_msgs__msg__RobotState * msg = (niryo_one_msgs__msg__RobotState *)allocator.allocate(sizeof(niryo_one_msgs__msg__RobotState), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(niryo_one_msgs__msg__RobotState));
  bool success = niryo_one_msgs__msg__RobotState__init(msg);
  if (!success) {
...
niryo_one_msgs__msg__RobotState__Sequence__init(niryo_one_msgs__msg__RobotState__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  niryo_one_msgs__msg__RobotState * data = NULL;

  if (size) {
    data = (niryo_one_msgs__msg__RobotState *)allocator.zero_allocate(size, sizeof(niryo_one_msgs__msg__RobotState), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = niryo_one_msgs__msg__RobotState__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        niryo_one_msgs__msg__RobotState__fini(&data[i - 1]);
      }
...
niryo_one_msgs__msg__RobotState__Sequence__fini(niryo_one_msgs__msg__RobotState__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      niryo_one_msgs__msg__RobotState__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  niryo_one_msgs__msg__RobotState__Sequence * array = (niryo_one_msgs__msg__RobotState__Sequence *)allocator.allocate(sizeof(niryo_one_msgs__msg__RobotState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = niryo_one_msgs__msg__RobotState__Sequence__init(array, size);
  if (!success) {
...
niryo_one_msgs__msg__RobotState__Sequence__destroy(niryo_one_msgs__msg__RobotState__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    niryo_one_msgs__msg__RobotState__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
niryo_one_msgs__msg__RobotState__Sequence__are_equal(const niryo_one_msgs__msg__RobotState__Sequence * lhs, const niryo_one_msgs__msg__RobotState__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!niryo_one_msgs__msg__RobotState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  niryo_one_msgs__msg__RobotState__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(niryo_one_msgs__msg__RobotState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    niryo_one_msgs__msg__RobotState * data =
      (niryo_one_msgs__msg__RobotState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!niryo_one_msgs__msg__RobotState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          niryo_one_msgs__msg__RobotState__fini(&output->data[i]);
        }
        return false;
      }
    }
