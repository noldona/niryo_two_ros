...
bool niryo_one_msgs__msg__rpy__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("niryo_one_msgs.msg._rpy.RPY", full_classname_dest, 27) == 0);
  }
  niryo_one_msgs__msg__RPY * ros_message = _ros_message;
  {  // roll
...
PyObject * niryo_one_msgs__msg__rpy__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("niryo_one_msgs.msg._rpy");
