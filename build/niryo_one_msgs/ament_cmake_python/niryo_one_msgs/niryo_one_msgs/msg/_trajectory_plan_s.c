...
bool niryo_one_msgs__msg__trajectory_plan__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("niryo_one_msgs.msg._trajectory_plan.TrajectoryPlan", full_classname_dest, 50) == 0);
  }
  niryo_one_msgs__msg__TrajectoryPlan * ros_message = _ros_message;
  {  // trajectory_start
...
PyObject * niryo_one_msgs__msg__trajectory_plan__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("niryo_one_msgs.msg._trajectory_plan");
