...
#define CAN_MOTOR_2_ID \
	2  // Those ids need to be used in niryo_one_motors.yaml to enable/disable some stepper motors
#define CAN_MOTOR_3_ID 3  //
#define CAN_MOTOR_4_ID 4  //

#define CAN_BROADCAST_ID \
	5  // all motors have positive filter for their own id + this one
