...
#include "mcp_can_rpi/mcp_can_dfs_rpi.hpp"
 ...
 *********************************************************************************************************/
	...
	void mcp2515_setRegisterS(
			const INT8U address,  // Set MCP2515 successive registers
	...
	void mcp2515_write_canMsg(
			const INT8U buffer_sidh_addr);  // Write CAN message
	void mcp2515_read_canMsg(const INT8U buffer_sidh_addr);  // Read CAN message
	INT8U mcp2515_getNextFreeTXBuf(
			INT8U *txbuf_n);  // Find empty transmit buffer
 ...
 *********************************************************************************************************/
	...
	INT8U begin(INT8U idmodeset, INT8U speedset,
			INT8U clockset);  // Initilize controller prameters
	...
	INT8U init_Filt(
			INT8U num, INT8U ext, INT32U ulData);  // Initilize Filter(s)
