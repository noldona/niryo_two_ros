...
#include "niryo_one_hardware/dxl_motor_state.hpp"  // For gripper enums

struct FakeCommunicationConfig {
	double pos_0;
	double pos_1;
	double pos_2;
	double pos_3;
...
class FakeCommunication: public CommunicationBase {
	public:
	FakeCommunication(int hardware_version, FakeCommunicationConfig cfg);
	int init();
