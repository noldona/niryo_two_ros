...
#include "niryo_one_hardware/stepper_motor_state.hpp"

#define TIME_TO_WAIT_IF_BUSY 500  // in microseconds
...
struct CanCommunicationConfig {
	int spi_channel;
	int spi_baudrate;
	int gpio_can_interrupt;
	double hw_control_loop_frequency;
	double hw_write_frequency;
	...
	double gear_ratio_6;
	double gear_ratio_7;
	double home_position_1;
	double home_position_2;
	double home_position_3;
	double home_position_4;
	double offset_position_1;
	double offset_position_2;
	double offset_position_3;
	double offset_position_4;
	double direction_1;
	double direction_2;
	double direction_3;
	double direction_4;
...
class CanCommunication {
	public:
	CanCommunication();
	int init(int hardware_version, CanCommunicationConfig cfg);
