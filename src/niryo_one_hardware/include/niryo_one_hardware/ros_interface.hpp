...
class RosInterface: public rclcpp::Node {
	public:
	RosInterface(CommunicationBase *niryo_one_comm,
	...
	void callbackCalibrateMotors(niryo_one_msgs::srv::SetInt::Request &req,
			niryo_one_msgs::srv::SetInt::Response &res);
	void callbackRequestNewCalibration(
			niryo_one_msgs::srv::SetInt::Request &req,
			niryo_one_msgs::srv::SetInt::Response &res);

	void callbackActivateLearningMode(niryo_one_msgs::srv::SetInt::Request &req,
			niryo_one_msgs::srv::SetInt::Response &res);
	void callbackActivateLeds(niryo_one_msgs::srv::SetLeds::Request &req,
			niryo_one_msgs::srv::SetLeds::Response &res);

	void callbackPingAndSetDxlTool(
			niryo_one_msgs::srv::PingDxlTool::Request &req,
			niryo_one_msgs::srv::PingDxlTool::Response &res);

	void callbackPingAndSetConveyor(
			niryo_one_msgs::srv::SetConveyor::Request &req,
			niryo_one_msgs::srv::SetConveyor::Response &res);
	void callbackControlConveyor(
			niryo_one_msgs::srv::ControlConveyor::Request &req,
			niryo_one_msgs::srv::ControlConveyor::Response &res);
	void callbackUpdateIdConveyor(
			niryo_one_msgs::srv::UpdateConveyorId::Request &req,
			niryo_one_msgs::srv::UpdateConveyorId::Response &res);

	void callbackOpenGripper(niryo_one_msgs::srv::OpenGripper::Request &req,
			niryo_one_msgs::srv::OpenGripper::Response &res);
	void callbackCloseGripper(niryo_one_msgs::srv::CloseGripper::Request &req,
			niryo_one_msgs::srv::CloseGripper::Response &res);

	void callbackPullAirVacuumPump(
			niryo_one_msgs::srv::PullAirVacuumPump::Request &req,
			niryo_one_msgs::srv::PullAirVacuumPump::Response &res);
	void callbackPushAirVacuumPump(
			niryo_one_msgs::srv::PushAirVacuumPump::Request &req,
			niryo_one_msgs::srv::PushAirVacuumPump::Response &res);

	void callbackChangeHardwareVersion(
			niryo_one_msgs::srv::ChangeHardwareVersion::Request &req,
			niryo_one_msgs::srv::ChangeHardwareVersion::Response &res);

	void callbackSendCustomDxlValue(
			niryo_one_msgs::srv::SendCustomDxlValue::Request &req,
			niryo_one_msgs::srv::SendCustomDxlValue::Response &res);

	void callbackRebootMotors(niryo_one_msgs::srv::SetInt::Request &req,
			niryo_one_msgs::srv::SetInt::Response &res);
};
