...
bool niryo_one_msgs__msg__digital_io_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("niryo_one_msgs.msg._digital_io_state.DigitalIOState", full_classname_dest, 51) == 0);
  }
  niryo_one_msgs__msg__DigitalIOState * ros_message = _ros_message;
  {  // pins
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->pins.data;
  ...
  {  // states
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int32_t * dest = ros_message->states.data;
      rc = PyBuffer_ToContiguous(dest, &view, view.len, 'C');
      if (rc < 0) {
        PyBuffer_Release(&view);
        Py_DECREF(field);
...
PyObject * niryo_one_msgs__msg__digital_io_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("niryo_one_msgs.msg._digital_io_state");
  ...
  {  // pins
    ...
    if (ros_message->pins.size > 0) {
      ...
      int32_t * src = &(ros_message->pins.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->pins.size * sizeof(int32_t));
      assert(data != NULL);
  ...
  {  // states
    ...
    if (ros_message->states.size > 0) {
      ...
      PyObject * frombytes = PyObject_GetAttrString(field, "frombytes");
      assert(frombytes != NULL);
      int32_t * src = &(ros_message->states.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->states.size * sizeof(int32_t));
      assert(data != NULL);
      PyObject * ret = PyObject_CallFunctionObjArgs(frombytes, data, NULL);
      Py_DECREF(data);
      Py_DECREF(frombytes);
