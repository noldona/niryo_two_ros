...
bool niryo_one_msgs__msg__position__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("niryo_one_msgs.msg._position.Position", full_classname_dest, 37) == 0);
  }
  niryo_one_msgs__msg__Position * ros_message = _ros_message;
  {  // name
...
PyObject * niryo_one_msgs__msg__position__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("niryo_one_msgs.msg._position");
