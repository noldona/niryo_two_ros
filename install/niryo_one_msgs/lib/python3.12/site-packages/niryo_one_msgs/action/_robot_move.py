    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'niryo_one_msgs.action.RobotMove_Goal')
            logger.debug(
            ...
            if RobotMoveCommand.__class__._TYPE_SUPPORT is None:
                RobotMoveCommand.__class__.__import_type_support__()
...
class RobotMove_Goal(metaclass=Metaclass_RobotMove_Goal):
    ...
    _fields_and_field_types = {
        'cmd': 'niryo_one_msgs/RobotMoveCommand',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['niryo_one_msgs', 'msg'], 'RobotMoveCommand'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from niryo_one_msgs.msg import RobotMoveCommand
        self.cmd = kwargs.get('cmd', RobotMoveCommand())
    ...
    def cmd(self, value):
        if self._check_fields:
            from niryo_one_msgs.msg import RobotMoveCommand
            assert \
                isinstance(value, RobotMoveCommand), \
                "The 'cmd' field must be a sub message of type 'RobotMoveCommand'"
        self._cmd = value
...
class Metaclass_RobotMove_Result(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'niryo_one_msgs.action.RobotMove_Result')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class Metaclass_RobotMove_Feedback(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'niryo_one_msgs.action.RobotMove_Feedback')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMove_Feedback(metaclass=Metaclass_RobotMove_Feedback):
    ...
    _fields_and_field_types = {
        'state': 'niryo_one_msgs/RobotState',
    }
...
class RobotMove_SendGoal_Request(metaclass=Metaclass_RobotMove_SendGoal_Request):
    ...
    _fields_and_field_types = {
        ...
        'goal': 'niryo_one_msgs/RobotMove_Goal',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['niryo_one_msgs', 'action'], 'RobotMove_Goal'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from niryo_one_msgs.action._robot_move import RobotMove_Goal
...
class Metaclass_RobotMove_SendGoal_Event(type):
    """Metaclass of message 'RobotMove_SendGoal_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__robot_move__send_goal__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__robot_move__send_goal__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__robot_move__send_goal__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__robot_move__send_goal__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__robot_move__send_goal__event
...
class RobotMove_SendGoal_Event(metaclass=Metaclass_RobotMove_SendGoal_Event):
    """Message class 'RobotMove_SendGoal_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<niryo_one_msgs/RobotMove_SendGoal_Request, 1>',
        'response': 'sequence<niryo_one_msgs/RobotMove_SendGoal_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['niryo_one_msgs', 'action'], 'RobotMove_SendGoal_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['niryo_one_msgs', 'action'], 'RobotMove_SendGoal_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from niryo_one_msgs.action import RobotMove_SendGoal_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, RobotMove_SendGoal_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'RobotMove_SendGoal_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from niryo_one_msgs.action import RobotMove_SendGoal_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, RobotMove_SendGoal_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'RobotMove_SendGoal_Response'"
...
class Metaclass_RobotMove_SendGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'niryo_one_msgs.action.RobotMove_SendGoal')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from niryo_one_msgs.action import _robot_move
            ...
            if _robot_move.Metaclass_RobotMove_SendGoal_Event._TYPE_SUPPORT is None:
                _robot_move.Metaclass_RobotMove_SendGoal_Event.__import_type_support__()


class RobotMove_SendGoal(metaclass=Metaclass_RobotMove_SendGoal):
    from niryo_one_msgs.action._robot_move import RobotMove_SendGoal_Request as Request
    from niryo_one_msgs.action._robot_move import RobotMove_SendGoal_Response as Response
    from niryo_one_msgs.action._robot_move import RobotMove_SendGoal_Event as Event
...
class RobotMove_GetResult_Response(metaclass=Metaclass_RobotMove_GetResult_Response):
    ...
    _fields_and_field_types = {
        'status': 'int8',
        'result': 'niryo_one_msgs/RobotMove_Result',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.NamespacedType(['niryo_one_msgs', 'action'], 'RobotMove_Result'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        if self._check_fields:
            assert all('_' + key in self.__slots__ for key in kwargs.keys()), \
                ...
                ', '.join(sorted(k for k in kwargs.keys() if '_' + k not in self.__slots__))
        self.status = kwargs.get('status', int())
        from niryo_one_msgs.action._robot_move import RobotMove_Result
...
class Metaclass_RobotMove_GetResult_Event(type):
    """Metaclass of message 'RobotMove_GetResult_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__action__robot_move__get_result__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__action__robot_move__get_result__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__action__robot_move__get_result__event
            cls._TYPE_SUPPORT = module.type_support_msg__action__robot_move__get_result__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__action__robot_move__get_result__event
...
class RobotMove_GetResult_Event(metaclass=Metaclass_RobotMove_GetResult_Event):
    """Message class 'RobotMove_GetResult_Event'."""
    ...
    _fields_and_field_types = {
        'info': 'service_msgs/ServiceEventInfo',
        'request': 'sequence<niryo_one_msgs/RobotMove_GetResult_Request, 1>',
        'response': 'sequence<niryo_one_msgs/RobotMove_GetResult_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['service_msgs', 'msg'], 'ServiceEventInfo'),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['niryo_one_msgs', 'action'], 'RobotMove_GetResult_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['niryo_one_msgs', 'action'], 'RobotMove_GetResult_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from niryo_one_msgs.action import RobotMove_GetResult_Request
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, RobotMove_GetResult_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'RobotMove_GetResult_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from niryo_one_msgs.action import RobotMove_GetResult_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, RobotMove_GetResult_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'RobotMove_GetResult_Response'"
        self._response = value
...
class Metaclass_RobotMove_GetResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'niryo_one_msgs.action.RobotMove_GetResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            if _robot_move.Metaclass_RobotMove_GetResult_Event._TYPE_SUPPORT is None:
                _robot_move.Metaclass_RobotMove_GetResult_Event.__import_type_support__()


class RobotMove_GetResult(metaclass=Metaclass_RobotMove_GetResult):
    from niryo_one_msgs.action._robot_move import RobotMove_GetResult_Request as Request
    from niryo_one_msgs.action._robot_move import RobotMove_GetResult_Response as Response
    from niryo_one_msgs.action._robot_move import RobotMove_GetResult_Event as Event
...
class Metaclass_RobotMove_FeedbackMessage(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'niryo_one_msgs.action.RobotMove_FeedbackMessage')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMove_FeedbackMessage(metaclass=Metaclass_RobotMove_FeedbackMessage):
    ...
    _fields_and_field_types = {
        'goal_id': 'unique_identifier_msgs/UUID',
        'feedback': 'niryo_one_msgs/RobotMove_Feedback',
    }
    ...
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['unique_identifier_msgs', 'msg'], 'UUID'),  # noqa: E501
        rosidl_parser.definition.NamespacedType(['niryo_one_msgs', 'action'], 'RobotMove_Feedback'),  # noqa: E501
    )
    ...
    def __init__(self, **kwargs):
        ...
        from unique_identifier_msgs.msg import UUID
        self.goal_id = kwargs.get('goal_id', UUID())
        from niryo_one_msgs.action._robot_move import RobotMove_Feedback
...
class Metaclass_RobotMove(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'niryo_one_msgs.action.RobotMove')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
...
class RobotMove(metaclass=Metaclass_RobotMove):
    ...
    from niryo_one_msgs.action._robot_move import RobotMove_Goal as Goal
    # The result message defined in the action definition.
    from niryo_one_msgs.action._robot_move import RobotMove_Result as Result
    # The feedback message defined in the action definition.
    from niryo_one_msgs.action._robot_move import RobotMove_Feedback as Feedback

    class Impl:

        # The send_goal service using a wrapped version of the goal message as a request.
        from niryo_one_msgs.action._robot_move import RobotMove_SendGoal as SendGoalService
        # The get_result service using a wrapped version of the result message as a response.
        from niryo_one_msgs.action._robot_move import RobotMove_GetResult as GetResultService
        # The feedback message with generic fields which wraps the feedback message.
        from niryo_one_msgs.action._robot_move import RobotMove_FeedbackMessage as FeedbackMessage
