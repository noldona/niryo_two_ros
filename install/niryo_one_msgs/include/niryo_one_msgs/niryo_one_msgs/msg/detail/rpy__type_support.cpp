...
{
  new (message_memory) niryo_one_msgs::msg::RPY(_init);
}

void RPY_fini_function(void * message_memory)
{
  auto typed_message = static_cast<niryo_one_msgs::msg::RPY *>(message_memory);
  typed_message->~RPY();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RPY_message_member_array[3] = {
  {
    ...
    offsetof(niryo_one_msgs::msg::RPY, roll),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_one_msgs::msg::RPY, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_one_msgs::msg::RPY, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
{
  return &::niryo_one_msgs::msg::rosidl_typesupport_introspection_cpp::RPY_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_one_msgs, msg, RPY)() {
  return &::niryo_one_msgs::msg::rosidl_typesupport_introspection_cpp::RPY_message_type_support_handle;
}
