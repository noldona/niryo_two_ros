...
#ifndef NIRYO_ONE_MSGS__MSG__DETAIL__TRAJECTORY_PLAN__TYPE_SUPPORT_H_
#define NIRYO_ONE_MSGS__MSG__DETAIL__TRAJECTORY_PLAN__TYPE_SUPPORT_H_
...
#endif  // NIRYO_ONE_MSGS__MSG__DETAIL__TRAJECTORY_PLAN__TYPE_SUPPORT_H_
