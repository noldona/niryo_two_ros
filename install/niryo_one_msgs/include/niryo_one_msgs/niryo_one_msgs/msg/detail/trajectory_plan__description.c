...
static char niryo_one_msgs__msg__TrajectoryPlan__FIELD_NAME__trajectory_start[] = "trajectory_start";
static char niryo_one_msgs__msg__TrajectoryPlan__FIELD_NAME__group_name[] = "group_name";
static char niryo_one_msgs__msg__TrajectoryPlan__FIELD_NAME__trajectory[] = "trajectory";

static rosidl_runtime_c__type_description__Field niryo_one_msgs__msg__TrajectoryPlan__FIELDS[] = {
  {
    {niryo_one_msgs__msg__TrajectoryPlan__FIELD_NAME__trajectory_start, 16, 16},
    {
  ...
  {
    {niryo_one_msgs__msg__TrajectoryPlan__FIELD_NAME__group_name, 10, 10},
    {
  ...
  {
    {niryo_one_msgs__msg__TrajectoryPlan__FIELD_NAME__trajectory, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription niryo_one_msgs__msg__TrajectoryPlan__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {niryo_one_msgs__msg__TrajectoryPlan__FIELDS, 3, 3},
    },
    {niryo_one_msgs__msg__TrajectoryPlan__REFERENCED_TYPE_DESCRIPTIONS, 27, 27},
  };
  if (!constructed) {
...
niryo_one_msgs__msg__TrajectoryPlan__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *niryo_one_msgs__msg__TrajectoryPlan__get_individual_type_description_source(NULL),
