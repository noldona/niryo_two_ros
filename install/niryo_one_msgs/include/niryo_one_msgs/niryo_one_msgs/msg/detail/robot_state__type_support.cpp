...
{
  new (message_memory) niryo_one_msgs::msg::RobotState(_init);
}

void RobotState_fini_function(void * message_memory)
{
  auto typed_message = static_cast<niryo_one_msgs::msg::RobotState *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember RobotState_message_member_array[2] = {
  {
    ...
    offsetof(niryo_one_msgs::msg::RobotState, position),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_one_msgs::msg::RobotState, rpy),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers RobotState_message_members = {
  ...
  2,  // number of fields
  sizeof(niryo_one_msgs::msg::RobotState),
...
{
  return &::niryo_one_msgs::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_one_msgs, msg, RobotState)() {
  return &::niryo_one_msgs::msg::rosidl_typesupport_introspection_cpp::RobotState_message_type_support_handle;
}
