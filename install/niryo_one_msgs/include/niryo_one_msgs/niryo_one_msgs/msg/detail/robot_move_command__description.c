...
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__cmd_type[] = "cmd_type";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__joints[] = "joints";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__position[] = "position";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__rpy[] = "rpy";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__shift[] = "shift";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__trajectory[] = "trajectory";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__pose_quat[] = "pose_quat";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__saved_position_name[] = "saved_position_name";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__saved_trajectory_id[] = "saved_trajectory_id";
static char niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__tool_cmd[] = "tool_cmd";

static rosidl_runtime_c__type_description__Field niryo_one_msgs__msg__RobotMoveCommand__FIELDS[] = {
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__cmd_type, 8, 8},
    {
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__joints, 6, 6},
    {
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__position, 8, 8},
    {
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__rpy, 3, 3},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__shift, 5, 5},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__trajectory, 10, 10},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__pose_quat, 9, 9},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__saved_position_name, 19, 19},
    {
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__saved_trajectory_id, 19, 19},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_INT32,
      0,
      0,
  ...
  {
    {niryo_one_msgs__msg__RobotMoveCommand__FIELD_NAME__tool_cmd, 8, 8},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription niryo_one_msgs__msg__RobotMoveCommand__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {niryo_one_msgs__msg__RobotMoveCommand__FIELDS, 10, 10},
    },
    {niryo_one_msgs__msg__RobotMoveCommand__REFERENCED_TYPE_DESCRIPTIONS, 31, 31},
  };
  if (!constructed) {
    ...
    description.referenced_type_descriptions.data[16].fields = niryo_one_msgs__msg__ShiftPose__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[17].fields = niryo_one_msgs__msg__ToolCommand__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[18].fields = niryo_one_msgs__msg__TrajectoryPlan__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[29].fields = trajectory_msgs__msg__MultiDOFJointTrajectory__get_type_description(NULL)->type_description.fields;
    ...
    description.referenced_type_descriptions.data[30].fields = trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__get_type_description(NULL)->type_description.fields;
    constructed = true;
  }
  return &description;
}
...
niryo_one_msgs__msg__RobotMoveCommand__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *niryo_one_msgs__msg__RobotMoveCommand__get_individual_type_description_source(NULL),
    ...
    sources[17] = *niryo_one_msgs__msg__ShiftPose__get_individual_type_description_source(NULL);
    sources[18] = *niryo_one_msgs__msg__ToolCommand__get_individual_type_description_source(NULL);
    sources[19] = *niryo_one_msgs__msg__TrajectoryPlan__get_individual_type_description_source(NULL);
    ...
    sources[30] = *trajectory_msgs__msg__MultiDOFJointTrajectory__get_individual_type_description_source(NULL);
    sources[31] = *trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__get_individual_type_description_source(NULL);
    constructed = true;
  }
