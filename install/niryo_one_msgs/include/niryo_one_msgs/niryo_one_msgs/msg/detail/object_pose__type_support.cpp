...
{
  new (message_memory) niryo_one_msgs::msg::ObjectPose(_init);
}

void ObjectPose_fini_function(void * message_memory)
{
  auto typed_message = static_cast<niryo_one_msgs::msg::ObjectPose *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ObjectPose_message_member_array[6] = {
  {
    ...
    offsetof(niryo_one_msgs::msg::ObjectPose, x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_one_msgs::msg::ObjectPose, y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_one_msgs::msg::ObjectPose, z),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_one_msgs::msg::ObjectPose, roll),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_one_msgs::msg::ObjectPose, pitch),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(niryo_one_msgs::msg::ObjectPose, yaw),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ObjectPose_message_members = {
  ...
  6,  // number of fields
  sizeof(niryo_one_msgs::msg::ObjectPose),
...
get_message_type_support_handle<niryo_one_msgs::msg::ObjectPose>()
{
  return &::niryo_one_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectPose_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, niryo_one_msgs, msg, ObjectPose)() {
  return &::niryo_one_msgs::msg::rosidl_typesupport_introspection_cpp::ObjectPose_message_type_support_handle;
}
