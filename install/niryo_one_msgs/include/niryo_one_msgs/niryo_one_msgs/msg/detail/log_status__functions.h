...
#ifndef NIRYO_ONE_MSGS__MSG__DETAIL__LOG_STATUS__FUNCTIONS_H_
#define NIRYO_ONE_MSGS__MSG__DETAIL__LOG_STATUS__FUNCTIONS_H_
 ...
 * )) before or use
 * niryo_one_msgs__msg__LogStatus__create()
 ...
 * calls
 * niryo_one_msgs__msg__LogStatus__init().
...
/**
 * It calls
 * niryo_one_msgs__msg__LogStatus__fini()
...
niryo_one_msgs__msg__LogStatus__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support);
 ...
 * niryo_one_msgs__msg__LogStatus__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * niryo_one_msgs__msg__LogStatus__Sequence__fini()
 * on the array,
...
#endif  // NIRYO_ONE_MSGS__MSG__DETAIL__LOG_STATUS__FUNCTIONS_H_
